...
- Scripts used for data transformation and satistics ([XSLT](https://github.com/laurauntner/sappho-digital/tree/main/data/xslt) and [Python](https://github.com/laurauntner/sappho-digital/tree/main/data/python)).
